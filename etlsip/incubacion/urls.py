...
urlpatterns = [
    ...
    path("dashboard/venta-huevo/", views.etl_dashboard_venta_huevo, name="etl_dashboard_venta_huevo"),
    path("dashboard/prod-huevos/", views.etl_dashboard_prod_huevos, name="etl_dashboard_prod_huevos"),
    ...
    path("dashboard/venta-pollito-protein/", views.etl_dashboard_venta_pollito_protein, name="etl_dashboard_venta_pollito_protein"),
    ...
    path("execute/venta-huevo/", views.etl_execute_venta_huevo, name="etl_execute_venta_huevo"),
    path("execute/prod-huevos/", views.etl_execute_prod_huevos, name="etl_execute_prod_huevos"),
    ...
    path("execute/venta-pollito-protein/", views.etl_execute_venta_pollito_protein, name="etl_execute_venta_pollito_protein"),
    ...
    path("preview/venta-huevo/", views.etl_preview_venta_huevo, name="etl_preview_venta_huevo"),
    path("preview/prod-huevos/", views.etl_preview_prod_huevos, name="etl_preview_prod_huevos"),
    ...
    path("preview/venta-pollito-protein/", views.etl_preview_venta_pollito_protein, name="etl_preview_venta_pollito_protein"),
